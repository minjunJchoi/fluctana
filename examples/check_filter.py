...
# A.filt('FIR_pass',0,150000,b=0.01,verbose=0) 

# high pass filter; 10000 < f
# A.filt('FIR_pass',100000,0,b=0.01,verbose=0)

# band pass filter; 5000 < f < 50000
# A.filt('FIR_pass',50000,0,b=0.01,verbose=0) 
# A.filt('FIR_pass',0,500000,b=0.01,verbose=0) 

# band block filter; f < 50000 and f > 150000
# A.filt('FIR_block',50000,150000,0.01,verbose=0) # smaller b is sharper
