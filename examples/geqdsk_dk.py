...
class geqdsk_dk(Geqdsk):
    ...
    #   f=interpolate.interp2d(r,z,self.get('psirz'),kind='linear')
      f=interpolate.RectBivariateSpline(r,z,self.get('psirz'),kx=1,ky=1)
    ...
    def get_psi(self):        
      ...
      if not self.psi_inter:
        ...
        #   self.f=interpolate.interp2d(r,z,self.get('psirz'),kind='quintic')
          self.f=interpolate.RectBivariateSpline(r,z,self.get('psirz'),kx=5,ky=5)
          self.psi_inter = True
      else:
          pass;
      return self.f
    def get_psi_normal(self):
        ...
        #   self.f_normal=interpolate.interp2d(r,z,(self.get('psirz')-psi_mag)/psiw,kind='quintic')
          self.f_normal=interpolate.RectBivariateSpline(r,z,(self.get('psirz')-psi_mag)/psiw,kx=5,ky=5)
